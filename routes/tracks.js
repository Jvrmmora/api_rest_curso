...
const { getItems,getItem,createItem, updateItem, deleteItem } = require("../controllers/tracks") //llamado del controlador
const { validatorCreateItem, validatorGetItem } = require("../validators/tracks") //llamado validador
